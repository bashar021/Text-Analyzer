...
import clearicon from './trash.png'
import uppercaseicon from './uppercase2.png'
import lowercaseicon from './lowercase4.png'
...
export default function Body(props) {
  ...
  return (
    <>
    {/* style={{backgroundColor:props.backgrounds.body} */}
    {/* cols="120" */}
    <div id='body_main_cont' className={`body_main_cont_${props.mode}`}>
        <div id='inputfield_container'>
            ...
            <div className="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                {/* <div class="btn-group" id='drop_btn' role="group"> */}
                  <button id="btnGroupDrop1" type="button" class={`btn btn-outline-${props.mode === 'dark'?'secondary':'primary'} dropdown-toggle btns_${props.mode}`} data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src={title} alt="" /></button>
                  <div className={`dropdown-menu drop_down_${props.mode}`} aria-labelledby="btnGroupDrop1">
